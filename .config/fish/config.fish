...
set VISUAL "$TERMINAL -e nvim"   # $VISUAL use Emacs in GUI mode
...
# a modifed base color theme
# set -L
set -U fish_color_normal normal
set -U fish_color_command 00ffd7
set -U fish_color_quote ffd700
set -U fish_color_redirection d787ff
set -U fish_color_end 00ff5f
...
set -U fish_color_comment ffd700
